...
describe MembersController do
  ...
  describe "PUT update" do
    ...
    it "ログインユーザ以外のメンバーのプロフィールは変更できない" do
      Member.stub(:find).with("1") { mock_member(:uid => "your_uid") }
      request.session[:uid] = "my_uid"
      mock_member.stub(:update_attributes).and_return(false)
      put :update, :id => "1", :member => { :name => "who" }
    end
  end
